            ...
            {isOpen && 
                <div 
                    ...
                    <form 
                        ...
                        <div className='flex flex-col gap-1 text-xs h-1/6 w-9/10'>
                            <label for='finance-amount'><h3>Amount ($)</h3></label>
                            <input name='finance-amount' type='text' placeholder='0.00' className='border border-border rounded w-full h-2/3 ps-1'></input>
                        </div>
                        <div className='flex flex-col gap-1 text-xs h-1/6 w-9/10'>
